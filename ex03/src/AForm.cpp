...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/17 00:40:27 by ikhanenk          #+#    #+#             */
/*   Updated: 2025/07/04 22:50:43 by ikhanenk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(const std::string& name, int n, int s, int e): 
	name_(name), 
	signed_(n),
	toSign_(s), 
	toExecute_(e)
...
AForm::AForm(const std::string& target): signed_(0), toSign_(0), toExecute_(0), target_(target)
{
	target_ = target;
